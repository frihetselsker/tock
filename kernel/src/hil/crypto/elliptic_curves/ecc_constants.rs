...
pub const P_256_P_SIZE: usize = 32;

impl Curve<P_256_P_SIZE> for NistP256Constants {
    const GENERATOR: ([u8; P_256_P_SIZE], [u8; P_256_P_SIZE]) = (
        [
    ...
    const EQ_PARAMS: ([u8; P_256_P_SIZE], [u8; P_256_P_SIZE]) = (
        [
