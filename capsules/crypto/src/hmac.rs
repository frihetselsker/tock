...
pub struct Hmac<H: crypto::digest::Hmac + 'static> {
...
impl<H: crypto::digest::Hmac> Client for Hmac<H> {
...
impl<H: crypto::digest::Hmac> SyscallDriver for Hmac<H> {
    fn command(
        &self,
        command_num: usize,
        data1: usize,
